...
public class Registrarse extends javax.swing.JFrame {
    ...
    public Registrarse() {
        ...
        emailNuevo.setToolTipText("Introduzca su nuevo email");
        botonCrearCuenta.setToolTipText("Boton para crear cuenta nueva");
        usuarioNuevo.putClientProperty("JTextField.placeholderText", "ingrese el username");
        contrasenaNueva.putClientProperty("JTextField.placeholderText", "ingrese la contraseña");
        emailNuevo.putClientProperty("JTextField.placeholderText", "ingrese el email");
    ...
    private void initComponents() {
        ...
        botonvolver.setPreferredSize(new java.awt.Dimension(50, 33));
    ...
    private void botonCrearCuentaMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonCrearCuentaMouseExited
        setCursor(Cursor.getDefaultCursor());
         botonCrearCuenta.setBackground(new Color(0, 0, 0));
